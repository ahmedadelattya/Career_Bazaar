...
Route::middleware('guest')->group(function () {
    Route::get('/choose-role', [RoleController::class, 'showRoleSelection'])
                ->name('choose-role');

    Route::get('/register-role', [RegisteredUserController::class, 'showRegistrationForm'])
                ->name('register-role');

    Route::get('/employer-register', [RegisteredUserController::class, 'showEmployerRegisterForm'])->name('employer-register');
