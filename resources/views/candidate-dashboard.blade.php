            ...
            <div class="overflow-x-auto bg-white rounded-lg shadow-md dark:bg-zinc-800">
                <table id="default-table" class="min-w-full text-sm bg-white dark:bg-zinc-800">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach ($jobs as $job)
                        <tr>
                            <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">{{ $job->title }}</td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">{{ $job->user->name }}</td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">{{ $job->category }}</td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">{{ $job->location }}</td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">{{ $job->salary_type }}</td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">{{ $job->salary }}</td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">{{ $job->status }}</td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap">{{ $job->created_at }}</td>
