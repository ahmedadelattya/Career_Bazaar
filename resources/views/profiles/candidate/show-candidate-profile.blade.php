<x-app-layout>
    <div class="container mx-auto p-6">
        <!-- Profile Section -->
        <div
            class="bg-white dark:bg-zinc-800 shadow-lg rounded-xl p-8 flex flex-col gap-8 md:gap-0 md:flex-row items-start md:space-x-8">
                            ...
                            @foreach($user->candidate_projects as $project)
                                <div>
                                    <a href="{{ $project }}" target="_blank"
                                        class="flex items-center gap-2 text-zinc-800 dark:text-zinc-200 hover:text-indigo-600 dark:hover:text-indigo-500 hover:underline underline-offset-4 text-sm duration-200 ">
