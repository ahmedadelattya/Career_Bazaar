    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="mt-6">
                ...
                <div class="flex flex-wrap justify-center">
                    @if ($user->candidate_skills)
                        ...
                        @endforeach
                    @else
                        <p>There is no record for "Skills"</p>
                    @endif
                </div>
            </div>
            <!-- projects -->
            <div class="mt-6">
                ...
                <div class="flex flex-wrap justify-center">
                    @if ($user->candidate_projects)
                        @foreach ($user->candidate_projects as $project)
                            <span
                                class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{{ $project }}</span>
                        @endforeach
                    @else
                        <p>There is no record for "Projects"</p>
                    @endif
                </div>
            </div>
        </div>
