<x-app-layout>
    <div class="py-12">
                            ...
                            <div>
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <input type="text" id="salary-input"
                                        value="{{ old('salary_type', $job->salary_type) == 'fixed' ? old('fixed_salary', $job->fixed_salary) : old('hourly_rate', $job->hourly_rate) }}"
        ...
        border-zinc-300 dark:border-zinc-700 dark:bg-zinc-700 dark:text-zinc-300 focus:border-indigo-500 dark:focus:border-indigo-600 shadow-sm border-l-0 border-l-transparent" />
                        ...
                        <div class="space-y-6 sm:space-y-0 sm:pl-3 flex flex-col gap-6">
                            <!-- Category -->
                            <div class="">
                            ...
                            <div class="">
                                ...
                                <select id="workPlace" name="work_place"
                                    ...
                                    <option value="on-site" {{ old('work_place') == 'on-site' ? 'selected' : '' }}>
                                        On-site</option>
                                    <option value="remote" {{ old('work_place') == 'remote' ? 'selected' : '' }}>
                                        Remote
                                    </option>
                                    <option value="hybrid" {{ old('work_place') == 'hybrid' ? 'selected' : '' }}>
                                        Hybrid
                                    </option>
                                </select>
                            </div>
